...
\maketitle
\begin{center}
\textbf{Research manuscript; primary Theorem~\ref{main} formally verified.}\\
Lean 4.31.0 formal verification of the primary Theorem~\ref{main}: complete.
\end{center}
\begin{abstract}
...
\medskip\noindent\textbf{Lean 4.31.0 verification of the primary Theorem~\ref{main}: complete.}
